...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(797, 753)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(40, 90, 361, 281))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(410, 90, 361, 281))
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.groupBox_2)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 161, 201))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(40, 370, 731, 131))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(40, 500, 731, 91))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(40, 590, 491, 101))
        self.groupBox_5.setObjectName("groupBox_5")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.groupBox_5)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 160, 71))
        ...
        self.textBrowser_6.setGeometry(QtCore.QRect(190, 20, 131, 21))
        self.textBrowser_6.setObjectName("textBrowser_6")
        self.textBrowser_7 = QtWidgets.QTextBrowser(self.groupBox_5)
        self.textBrowser_7.setGeometry(QtCore.QRect(190, 60, 131, 21))
        self.textBrowser_7.setObjectName("textBrowser_7")
        self.button6 = QtWidgets.QPushButton(self.groupBox_5)
        self.button6.setGeometry(QtCore.QRect(340, 20, 121, 28))
        self.button6.setObjectName("button6")
        self.button7 = QtWidgets.QPushButton(self.groupBox_5)
        self.button7.setGeometry(QtCore.QRect(340, 60, 121, 28))
        self.button7.setObjectName("button7")
        self.lineEdit_3 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_3.setGeometry(QtCore.QRect(260, 265, 121, 22))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(260, 130, 121, 22))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(260, 200, 121, 22))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.groupBox_6 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_6.setGeometry(QtCore.QRect(540, 590, 231, 101))
        self.groupBox_6.setObjectName("groupBox_6")
        self.verticalLayoutWidget_4 = QtWidgets.QWidget(self.groupBox_6)
        self.verticalLayoutWidget_4.setGeometry(QtCore.QRect(10, 20, 211, 31))
        ...
        self.button8.setGeometry(QtCore.QRect(60, 60, 121, 28))
        self.button8.setObjectName("button8")
        self.groupBox_7 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_7.setGeometry(QtCore.QRect(40, 10, 731, 81))
        self.groupBox_7.setObjectName("groupBox_7")
        self.verticalLayoutWidget_5 = QtWidgets.QWidget(self.groupBox_7)
        self.verticalLayoutWidget_5.setGeometry(QtCore.QRect(10, 20, 711, 51))
...
"The recommended range is 2.0-3.0 Bohr."))
        ...
        self.label_14.setText(_translate("MainWindow", "Resets directory. Does not save."))
        self.button8.setText(_translate("MainWindow", "Reset"))
        self.groupBox_7.setTitle(_translate("MainWindow", "Read"))
        self.label_15.setText(_translate("MainWindow", "Please make sure Perl, one Fortran compiler (e.g., ifort, GFortran) and one linear algebra library (e.g. MKL, AOCL \n"
"are installed and loaded, and then modify the Makefiles accordingly. Refer to ReadMe for software requirements."))
